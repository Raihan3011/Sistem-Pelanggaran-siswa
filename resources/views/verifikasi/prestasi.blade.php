...
@section('page-description', 'Verifikasi data prestasi yang diinput guru')

@section('content')
<div class="content-card">
    <h4 style="margin-bottom: 20px;">Prestasi Menunggu Verifikasi</h4>
        ...
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <button class="btn btn-success" style="padding: 5px 10px; font-size: 0.8rem;" onclick="showModal({{ $p->prestasi_id }}, 'Terverifikasi')">
                            <i class="bi bi-check-circle"></i> Terima
                        </button>
                        <button class="btn btn-danger" style="padding: 5px 10px; font-size: 0.8rem;" onclick="showModal({{ $p->prestasi_id }}, 'Ditolak')">
                ...
                @empty
                <tr>
                    <td colspan="9" style="text-align: center; padding: 20px; color: #666;">Tidak ada prestasi yang menunggu verifikasi</td>
                </tr>
                @endforelse
            </tbody>
        </table>
...
<div id="verifikasiModal" style="display: none; position: fixed; top: 0; left: 0; width: 100%; height: 100%; background: rgba(0,0,0,0.5); z-index: 9999; align-items: center; justify-content: center;">
    <div style="background: white; padding: 30px; border-radius: 15px; width: 500px; max-width: 90%;">
        <h4 style="margin-bottom: 20px;">Verifikasi Prestasi</h4>
...
<script>
function showModal(prestasiId, status) {
    document.getElementById('verifikasiForm').action = '/verifikasi/prestasi/' + prestasiId;
