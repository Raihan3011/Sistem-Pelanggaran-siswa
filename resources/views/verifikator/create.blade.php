...
@section('page-title', 'Tambah Verifikator')
@section('page-description', 'Tambah verifikator baru')

@section('content')
<div class="content-card">
    <form action="{{ route('verifikator.store') }}" method="POST">
        @csrf
        ...
        <div style="margin-bottom: 20px;">
            ...
            <input type="text" name="nama_verifikator" class="form-control" value="{{ old('nama_verifikator') }}" required style="width: 100%; padding: 10px; border: 1px solid #ddd; border-radius: 8px;">
        ...
        <div style="margin-bottom: 20px;">
            ...
            <input type="text" name="nip" class="form-control" value="{{ old('nip') }}" style="width: 100%; padding: 10px; border: 1px solid #ddd; border-radius: 8px;">
            @error('nip')
                <span style="color: var(--danger); font-size: 0.8rem;">{{ $message }}</span>
            @enderror
        </div>
