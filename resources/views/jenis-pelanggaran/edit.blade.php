...
@section('page-description', 'Edit data jenis pelanggaran')

@section('content')
<div class="content-card">
    <form action="{{ route('jenis-pelanggaran.update', $jenisPelanggaran->jenis_pelanggaran_id) }}" method="POST">
        @csrf
        @method('PUT')
        ...
        <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 20px;">
            <div style="grid-column: 1 / -1;">
                ...
                <input type="text" name="nama_pelanggaran" value="{{ old('nama_pelanggaran', $jenisPelanggaran->nama_pelanggaran) }}" required style="width: 100%; padding: 10px; border: 1px solid #e5e7eb; border-radius: 8px;">
            ...
            <div style="grid-column: 1 / -1;">
                ...
                <select name="kategori" required style="width: 100%; padding: 10px; border: 1px solid #e5e7eb; border-radius: 8px;">
                    @foreach($kategoriOptions as $kategori)
                        <option value="{{ $kategori }}" {{ old('kategori', $jenisPelanggaran->kategori) == $kategori ? 'selected' : '' }}>{{ $kategori }}</option>
                    @endforeach
                </select>
            ...
            <div>
                ...
                <input type="number" name="poin_minimal" value="{{ old('poin_minimal', $jenisPelanggaran->poin_minimal ?? 1) }}" required min="1" max="100" style="width: 100%; padding: 10px; border: 1px solid #e5e7eb; border-radius: 8px;">
            ...
            <div>
                ...
                <input type="number" name="poin_maksimal" value="{{ old('poin_maksimal', $jenisPelanggaran->poin_maksimal ?? 15) }}" required min="1" max="100" style="width: 100%; padding: 10px; border: 1px solid #e5e7eb; border-radius: 8px;">
            ...
            <div style="grid-column: 1 / -1;">
                ...
                <textarea name="deskripsi" rows="4" style="width: 100%; padding: 10px; border: 1px solid #e5e7eb; border-radius: 8px;">{{ old('deskripsi', $jenisPelanggaran->deskripsi) }}</textarea>
            ...
            <div style="grid-column: 1 / -1;">
                ...
                <textarea name="sanksi_rekomendasi" rows="3" style="width: 100%; padding: 10px; border: 1px solid #e5e7eb; border-radius: 8px;">{{ old('sanksi_rekomendasi', $jenisPelanggaran->sanksi_rekomendasi) }}</textarea>
