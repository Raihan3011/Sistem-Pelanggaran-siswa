...
<html>
<head>
    <title>Laporan Bulanan Pelanggaran</title>
    <style>
...
<body>
    ...
    <h3>Laporan Bulanan Pelanggaran Siswa</h3>
    <p class="text-center">Periode: {{ date('F Y', mktime(0, 0, 0, $bulan, 1, $tahun)) }}</p>
    ...
    <table>
        ...
        <tfoot>
            <tr>
                <th colspan="6" class="text-center">Total Poin</th>
