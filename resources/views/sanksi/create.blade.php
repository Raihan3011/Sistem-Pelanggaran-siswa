...
@section('page-description', 'Tambah sanksi pelanggaran')
...
<div class="content-card">
    ...
    <div style="padding: 20px; background: #fef3c7; border: 1px solid #fbbf24; border-radius: 8px; margin-bottom: 20px;">
        <strong>Informasi:</strong> Tidak ada pelanggaran yang tersedia untuk diberi sanksi. 
        Pastikan ada pelanggaran dengan status "Terverifikasi" yang belum memiliki sanksi.
    </div>
    @endif
        ...
        <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 20px;">
            ...
            <div>
                ...
                <select name="jenis_sanksi" required style="width: 100%; padding: 10px; border: 1px solid #e5e7eb; border-radius: 8px;">
                    ...
                    <option value="{{ $js->nama_sanksi }}" {{ old('jenis_sanksi') == $js->nama_sanksi ? 'selected' : '' }}>
            ...
            <div>
                ...
                <select name="guru_penanggung_jawab" required style="width: 100%; padding: 10px; border: 1px solid #e5e7eb; border-radius: 8px;">
                    ...
                    @foreach($guru as $g)
                    <option value="{{ $g->user_id }}" {{ old('guru_penanggung_jawab') == $g->user_id ? 'selected' : '' }}>
            ...
            <div>
                ...
                <input type="date" name="tanggal_mulai" value="{{ old('tanggal_mulai') }}" required style="width: 100%; padding: 10px; border: 1px solid #e5e7eb; border-radius: 8px;">
            ...
            <div>
                ...
                <input type="date" name="tanggal_selesai" value="{{ old('tanggal_selesai') }}" required style="width: 100%; padding: 10px; border: 1px solid #e5e7eb; border-radius: 8px;">
            ...
            <div style="grid-column: 1 / -1;">
                ...
                <textarea name="deskripsi_sanksi" rows="4" required style="width: 100%; padding: 10px; border: 1px solid #e5e7eb; border-radius: 8px;">{{ old('deskripsi_sanksi') }}</textarea>
